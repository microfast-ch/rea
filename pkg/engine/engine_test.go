...
func TestIterationTarget(t *testing.T) {
	t.SkipNow() // TODO
...
/*
   // TODO: This is how it is generated by libreoffice

   // Iterations in a list
   <list>
     <list-item>
       <p>
         <span>[[ for i=1,2 do ]]</span>
         <span>List [# i #][[ end ]]</span>
       </p>
     </list-item>
   </list>

   // Iterations in a table, simple case
   ...
   // Iterations in a table, more complex case
   <table>
     <table-column/>
     <table-column/>
     <table-column/>
